"""
main.py — Capa de Transporte RabbitMQ (Worker de Visión YOLOv8)
================================================================
Responsabilidad EXCLUSIVA: gestión de conexiones, colas y mensajes.
Toda la lógica de negocio vive en worker.py.

Flujo:  q_snapshots (entrada) → worker.procesar_frame() → q_infracciones (salida)
"""
...
from worker import procesar_frame
...
def iniciar_worker():
    ...
    while True:
        try:
            ...
            retry_delay = 5
            print(f"[*] Worker YOLOv8 (Soft Evidence) iniciado.")
