...
describe('KalmanFilter', () => {
    ...
    describe('filtering', () => {
        it('should smooth noisy measurements towards stable value', () => {
            ...
            // Un pico repentino debe suavizarse
        ...
        it('should converge towards the true value over time', () => {
            ...
            // Alimentar mediciones estables en 1.0 — el filtro debe converger
            let lastResult = 0;
            for (let i = 0; i < 20; i++) {
        ...
        it('should give different results depending on q and r parameters', () => {
            // r alto = confía más en el modelo (filtro más lento)
            const slowFilter = new KalmanFilter(0.1, 10);
            // r bajo = confía más en las mediciones (filtro más rápido)
            ...
            // Filtro rápido converge más rápido → valor más alto después de un paso
    ...
    describe('reset', () => {
        it('should re-initialize with next measurement after reset', () => {
            ...
            // Después del reset, la primera medición debe retornarse tal cual
