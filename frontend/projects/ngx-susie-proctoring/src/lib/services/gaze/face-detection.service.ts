...
export class FaceDetectionService {
    ...
    handleNoFace(): void {
        ...
        this.loggerService.warn('Rostro no detectado — Iniciando grace period de 3s');
    ...
    handleFaceDetected(): boolean {
        ...
        if (wasLost) {
            this.loggerService.log('Rostro detectado nuevamente');
        }
        this.reset();
    ...
    private triggerInfraction(): void {
        this.loggerService.error('INFRACCIÓN: Rostro no detectado por tiempo prolongado');
