...
export class SignalSmoothingService {
    ...
    // Último resultado suavizado para rechazo de outliers (valores normalizados)
    ...
    process(rawX: number, rawY: number, confidence?: number): GazePoint | null {
        ...
        // Promedio ponderado lineal del window (más reciente = mayor peso)
     ...
     * - Weights: [1, 2, 3] (más antiguo a más reciente)
     * - Normalizado: [1/6, 2/6, 3/6]
     * - Window [10, 20, 30] → (10*1 + 20*2 + 30*3) / 6 = 23.33
     *
     * @param values Array de valores (ordenados de más antiguo a más reciente)
