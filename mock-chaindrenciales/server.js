 ...
 * 
 * Uso: cd mock-chaindrenciales && npm install && npm start
 * 
...
// ============================================
// DATOS MOCK - 50 preguntas de Angular
// ============================================
...
const EXAM_DATA = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['*ngIf="condition"', 'v-if="condition"', '@if (condition) { }', '{{#if condition}}']
    },
    {
      id: 5,
      content: '¿Qué función se usa para inyección de dependencias en Angular moderno?',
      options: ['constructor injection solamente', 'inject()', '@Inject() decorator', 'provide()']
    },
    {
      id: 6,
      content: '¿Qué es un Observable en RxJS?',
      options: ['Una promesa', 'Un flujo de eventos asíncrono', 'Una función puramente síncrona', 'Un tipo de array inmutable']
    },
    {
      id: 7,
      content: '¿Cuál es la diferencia principal entre interface y type en TypeScript?',
      options: ['Solo interface soporta merging de declaraciones', 'Solo type puede ser exportado', 'Interface no soporta herencia', 'Type es solo para primitivos']
    },
    {
      id: 8,
      content: '¿Qué significa que un Pipe sea "puro"?',
      options: ['Que no tiene efectos secundarios', 'Que solo se ejecuta si cambia la referencia de entrada', 'Que usa ChangeDetectionStrategy.OnPush', 'Que no depende de servicios externos']
    },
    {
      id: 9,
      content: '¿Cuál selector CSS tiene mayor especificidad?',
      options: ['#id', '.clase', 'div', '*']
    },
    {
      id: 10,
    ...
    },
    {
      ...
      options: ['Ejecuta el script inmediatamente', 'Ejecuta el script después de parsear el HTML', 'Bloquea el renderizado', 'Carga el script síncronamente']
    },
    {
      id: 12,
      content: '¿Cuál es el propósito de "track" en el nuevo @for loop?',
      options: ['Rastrear analíticas de usuario', 'Optimizar el rendimiento del DOM diffing', 'No es obligatorio', 'Ordenar la lista alfabéticamente']
    },
    {
      id: 13,
      content: '¿Qué es el "Event Loop" en JavaScript?',
      options: ['Un bucle infinito for(;;)', 'El mecanismo que maneja la ejecución asíncrona', 'Un evento que se repite cada segundo', 'El ciclo de vida de un componente']
    },
    {
      id: 14,
      content: '¿Cuál es la diferencia entre "merge" y "switchMap"?',
      options: ['merge cancela la suscripción anterior', 'switchMap cancela la suscripción anterior', 'Son idénticos', 'merge solo funciona con promesas']
    },
    {
      id: 15,
      content: '¿Para qué sirve NgZone?',
      options: ['Para definir zonas horarias', 'Para ejecutar código fuera de la detección de cambios de Angular', 'Para manejar rutas', 'Para estilos encapsulados']
    },
    {
      id: 16,
      content: '¿Qué es Shadow DOM?',
      options: ['El DOM virtual de React', 'Una copia oculta del DOM para pruebas', 'Encapsulación real de estilos y markup', 'Un modo oscuro para el navegador']
    },
    {
      id: 17,
    ...
    },
    {
      ...
      options: ['*ngIf', '[hidden]', 'ngStyle', 'ngClass']
    },
    {
      id: 19,
      content: '¿Qué es "Tree Shaking"?',
      options: ['Animación de sacudida', 'Eliminación de código muerto en el bundle final', 'Un patrón de diseño', 'Una técnica de testing']
    },
    {
      id: 20,
      content: '¿Cuál es el ciclo de vida único de los Signals?',
      options: ['ngOnSignalChange', 'No tienen ciclo de vida explícito, son reactivos', 'ngSignalInit', 'ngAfterSignalChecked']
    },
    {
      id: 21,
      content: '¿Qué hace "takeUntilDestroyed"?',
      options: ['Destruye el componente inmediatamente', 'Desuscribe automáticamente Observables al destruir el contexto', 'Pausa la ejecución hasta que se destruye el objeto', 'Borra el LocalStorage']
    },
    {
      id: 22,
      content: '¿Qué es hydration en SSR?',
      options: ['Tomar agua durante el coding', 'Añadir interactividad JS al HTML estático del servidor', 'Descargar assets', 'Compilar TypeScript']
    },
    {
      id: 23,
      content: '¿Cuál es la diferencia entre "root" y "platform" injectors?',
      options: ['No hay diferencia', 'Platform es global para múltiples apps en la página', 'Root es solo para servicios http', 'Platform es obsoleto']
    },
    {
      id: 24,
      content: '¿Qué es "Content Projection"?',
      options: ['Proyectar la pantalla en un TV', 'Insertar contenido HTML dentro de un componente (<ng-content>)', 'Validar formularios', 'Animaciones CSS']
    },
    {
      id: 25,
      content: '¿Para qué sirve el pipe "async"?',
      options: ['Para hacer el código más rápido', 'Para suscribirse y desuscribirse automáticamente a Observables/Promesas en el template', 'Para llamadas HTTP POST', 'Para cargar módulos lazy']
    },
    {
      id: 26,
      content: '¿Qué es un Service Worker?',
      options: ['Un empleado de soporte técnico', 'Un script que el navegador ejecuta en segundo plano (caching, push)', 'Un servicio de Angular', 'Una API REST']
    },
    {
      id: 27,
      content: '¿Cuál es la mejor práctica para evitar Memory Leaks en suscripciones manuales?',
      options: ['No usar suscripciones', 'Usar .unsubscribe() en ngOnDestroy', 'Angular lo hace solo siempre', 'Reiniciar el navegador']
    },
    {
      id: 28,
      content: '¿Qué es "Lazy Loading"?',
      options: ['Cargar imágenes lentamente', 'Cargar módulos/componentes solo cuando se necesitan', 'Un spinner de carga', 'Programación perezosa']
    },
    {
      id: 29,
      content: '¿Cuál es la diferencia entre "null" y "undefined"?',
      options: ['Son lo mismo', 'null es un valor asignado explícitamente, undefined es no inicializado', 'undefined es un error', 'null es un objeto']
    },
    {
      id: 30,
      content: '¿Qué es SOLID?',
      options: ['Un estado de la materia', '5 principios de diseño orientado a objetos', 'Una librería de UI', 'Un framework de CSS']
    },
    {
      id: 31,
...
app.get('/api/evaluaciones/:id/susie-config', (req, res) => {
  ...
  console.log('[RESPONSE] Enviando configuración del examen con', EXAM_DATA.questions.length, 'preguntas');
  res.json(response);
});
...
app.listen(PORT, () => {
  ...
  console.log(`📝 Examen: ${EXAM_DATA.examTitle}`);
  console.log(`❓ Preguntas: ${EXAM_DATA.questions.length}`);
  console.log('');
